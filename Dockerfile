...
WORKDIR /root
RUN wget https://github.com/osrg/gobgp/releases/download/v2.12.0/gobgp_2.12.0_linux_amd64.tar.gz
RUN tar zxf gobgp_2.12.0_linux_amd64.tar.gz && mv gobgp /sbin/ && mv gobgpd /sbin/
RUN mkdir /etc/gobgp
